...
class RandomLottoTicketMachine : LottoTicketMachine {
    ...
    private val lottoNumberPool: List<LottoNumber> = LottoNumber.cache.values.toList()
    ...
    private fun createLottoTicket(): LottoTicket {
        val selectedNumbers = lottoNumberPool.shuffled().subList(0, LottoTicket.SIZE_OF_NUMBERS)
